...
// WrapFunc something that accepts an http.Handler, returns an http.Handler
func WrapFunc(hh func(h http.Handler) http.Handler) HandlerFunc {
	// Steps:
	...
	return func(c *Context) {
		hh(&nextRequestHandler{c}).ServeHTTP(c.Writer, c.Req)
	}
}
